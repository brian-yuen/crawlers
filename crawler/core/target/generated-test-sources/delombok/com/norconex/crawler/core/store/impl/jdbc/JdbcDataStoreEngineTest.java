...
class JdbcDataStoreEngineTest extends AbstractDataStoreEngineTest {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(JdbcDataStoreEngineTest.class);

    @Override
    protected DataStoreEngine createEngine() {
        try {
            var dbPath = StringUtils.removeStart(getTempDir().toAbsolutePath().toUri().toURL() + "test", "file:");
