...
class MongoDataStoreEngineTest extends AbstractDataStoreEngineTest {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(MongoDataStoreEngineTest.class);
    @Container
    static MongoDBContainer mongoDBContainer = new MongoDBContainer(DockerImageName.parse("mongo:4.2.0"));

    @Override
    protected DataStoreEngine createEngine() {
        var connStr = "mongodb://" + mongoDBContainer.getHost() + ":" + mongoDBContainer.getFirstMappedPort();
