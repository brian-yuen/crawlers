 ...
 * </p>
 */
public class CommonAttribsResolutionStage implements Predicate<ImporterPipelineContext> {
    @Override
    public boolean test(ImporterPipelineContext ctx) {
        CommonAttributesResolver.resolve(ctx.getDocument());
        return true;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CommonAttribsResolutionStage() {
    }
}
