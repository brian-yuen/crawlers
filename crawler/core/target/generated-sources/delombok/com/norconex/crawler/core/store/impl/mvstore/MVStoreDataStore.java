...
public class MVStoreDataStore<T> implements DataStore<T> {
    ...
    protected MVStoreDataStore(@NonNull MVStore mvstore, @NonNull String storeName, @NonNull Class<? extends T> type) {
    ...
    public boolean forEach(BiPredicate<String, T> predicate) {
        for (Entry<String, String> en : map.entrySet()) {
            if (!predicate.test(en.getKey(), toObject(en.getValue()).orElse(null))) {
                return false;
            }
        }
        return true;
