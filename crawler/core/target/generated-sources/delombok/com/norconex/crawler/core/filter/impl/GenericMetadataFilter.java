...
public class GenericMetadataFilter implements OnMatchFilter, MetadataFilter, DocumentFilter, Configurable<GenericMetadataFilterConfig> {
    private final GenericMetadataFilterConfig configuration = new GenericMetadataFilterConfig();
    ...
    public boolean acceptMetadata(String reference, Properties metadata) {
        if (isBlank(configuration.getFieldMatcher().getPattern()) || isBlank(configuration.getValueMatcher().getPattern()) || new PropertyMatcher(configuration.getFieldMatcher(), configuration.getValueMatcher()).matches(metadata)) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof GenericMetadataFilter)) return false;
        final GenericMetadataFilter other = (GenericMetadataFilter) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof GenericMetadataFilter;
    }
    ...
    public java.lang.String toString() {
        return "GenericMetadataFilter(configuration=" + this.getConfiguration() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public GenericMetadataFilterConfig getConfiguration() {
