...
public class StopCrawlerOnMaxEventListenerConfig {
     ...
     */
    public StopCrawlerOnMaxEventListenerConfig setEventMatcher(TextMatcher eventMatcher) {
    ...
    @lombok.Generated
    public StopCrawlerOnMaxEventListenerConfig() {
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public StopCrawlerOnMaxEventListenerConfig setOnMultiple(final OnMultiple onMultiple) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public StopCrawlerOnMaxEventListenerConfig setMaximum(final long maximum) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof StopCrawlerOnMaxEventListenerConfig)) return false;
        final StopCrawlerOnMaxEventListenerConfig other = (StopCrawlerOnMaxEventListenerConfig) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
        if (this.getMaximum() != other.getMaximum()) return false;
        final java.lang.Object this$eventMatcher = this.getEventMatcher();
        final java.lang.Object other$eventMatcher = other.getEventMatcher();
        if (this$eventMatcher == null ? other$eventMatcher != null : !this$eventMatcher.equals(other$eventMatcher)) return false;
        final java.lang.Object this$onMultiple = this.getOnMultiple();
        final java.lang.Object other$onMultiple = other.getOnMultiple();
        if (this$onMultiple == null ? other$onMultiple != null : !this$onMultiple.equals(other$onMultiple)) return false;
        return true;
    }
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof StopCrawlerOnMaxEventListenerConfig;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final long $maximum = this.getMaximum();
        result = result * PRIME + (int) ($maximum >>> 32 ^ $maximum);
        final java.lang.Object $eventMatcher = this.getEventMatcher();
        result = result * PRIME + ($eventMatcher == null ? 43 : $eventMatcher.hashCode());
        final java.lang.Object $onMultiple = this.getOnMultiple();
        result = result * PRIME + ($onMultiple == null ? 43 : $onMultiple.hashCode());
        return result;
    }
    ...
    public java.lang.String toString() {
        return "StopCrawlerOnMaxEventListenerConfig(eventMatcher=" + this.getEventMatcher() + ", onMultiple=" + this.getOnMultiple() + ", maximum=" + this.getMaximum() + ")";
    }
}
