...
public class GenericMetadataChecksummer extends AbstractMetadataChecksummer<GenericMetadataChecksummerConfig> {
    private final GenericMetadataChecksummerConfig configuration = new GenericMetadataChecksummerConfig();

    @Override
    protected String doCreateMetaChecksum(Properties metadata) {
        return ChecksumUtil.metadataChecksumPlain(metadata, getConfiguration().getFieldMatcher());
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public GenericMetadataChecksummerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof GenericMetadataChecksummer)) return false;
        final GenericMetadataChecksummer other = (GenericMetadataChecksummer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof GenericMetadataChecksummer;
    }
    ...
    public java.lang.String toString() {
        return "GenericMetadataChecksummer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
