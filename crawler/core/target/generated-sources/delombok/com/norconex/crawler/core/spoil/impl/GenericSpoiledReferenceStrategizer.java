 ...
 * </p>
 */
public class GenericSpoiledReferenceStrategizer implements SpoiledReferenceStrategizer, Configurable<GenericSpoiledReferenceStrategizerConfig> {
    private final GenericSpoiledReferenceStrategizerConfig configuration = new GenericSpoiledReferenceStrategizerConfig();

    @Override
    public SpoiledReferenceStrategy resolveSpoiledReferenceStrategy(String reference, CrawlDocState state) {
        var strategy = configuration.getMappings().get(state);
        if (strategy == null) {
            strategy = configuration.getFallbackStrategy();
        }
        if (strategy == null) {
            strategy = GenericSpoiledReferenceStrategizerConfig.DEFAULT_FALLBACK_STRATEGY;
        }
        return strategy;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof GenericSpoiledReferenceStrategizer)) return false;
        final GenericSpoiledReferenceStrategizer other = (GenericSpoiledReferenceStrategizer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof GenericSpoiledReferenceStrategizer;
    }
    ...
    public java.lang.String toString() {
        return "GenericSpoiledReferenceStrategizer(configuration=" + this.getConfiguration() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public GenericSpoiledReferenceStrategizerConfig getConfiguration() {
