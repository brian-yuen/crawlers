...
public class CrawlSessionStopperException extends RuntimeException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CrawlSessionStopperException(final java.lang.String message) {
        this(message, null);
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CrawlSessionStopperException(final java.lang.Throwable cause) {
        this(cause != null ? cause.getMessage() : null, cause);
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CrawlSessionStopperException(final java.lang.String message, final java.lang.Throwable cause) {
        super(message);
