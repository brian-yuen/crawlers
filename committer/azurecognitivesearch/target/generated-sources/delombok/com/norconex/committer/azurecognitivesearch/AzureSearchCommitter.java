...
public class AzureSearchCommitter extends AbstractBatchCommitter<AzureSearchCommitterConfig> {
    private final AzureSearchCommitterConfig configuration = new AzureSearchCommitterConfig();
    private AzureSearchClient client;

    @Override
    protected void initBatchCommitter() throws CommitterException {
        client = new AzureSearchClient(configuration);
        if (configuration.getQueue() instanceof FSQueue queue && queue.getConfiguration().getBatchSize() > 1000) {
            throw new CommitterException("Commit batch size cannot be greater than 1000.");
        }
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof AzureSearchCommitter)) return false;
        final AzureSearchCommitter other = (AzureSearchCommitter) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof AzureSearchCommitter;
    }
    ...
    public java.lang.String toString() {
        return "AzureSearchCommitter(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public AzureSearchCommitterConfig getConfiguration() {
