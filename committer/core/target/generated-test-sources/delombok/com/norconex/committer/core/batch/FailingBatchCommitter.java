...
public class FailingBatchCommitter extends AbstractBatchCommitter<BaseBatchCommitterConfig> {
    ...
    public FailingBatchCommitter(int failAtDocIndex, int recoverAtAttemptIndex) {
    ...
    protected void commitBatch(Iterator<CommitterRequest> it) throws CommitterException {
        ...
        while (it.hasNext()) {
            ...
            if (attempts < recoverAtAttemptIndex && cnt >= failAtDocIndex) {
                exceptionCount++;
                throw new CommitterException("Mock committer failure. Attempt #" + attempts + ". Doc #" + cnt);
            }
        }
