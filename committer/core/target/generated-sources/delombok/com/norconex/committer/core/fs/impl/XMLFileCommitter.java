...
public class XMLFileCommitter extends AbstractFSCommitter<EnhancedXMLStreamWriter, XMLFileCommitterConfig> {
    private final XMLFileCommitterConfig configuration = new XMLFileCommitterConfig();
    ...
    protected EnhancedXMLStreamWriter createDocWriter(Writer writer) throws IOException {
        var xml = new EnhancedXMLStreamWriter(writer, false, configuration.getIndent());
    ...
    protected void writeUpsert(EnhancedXMLStreamWriter xml, UpsertRequest upsertRequest) throws IOException {
        ...
        xml.writeElementString("content", IOUtils.toString(upsertRequest.getContent(), StandardCharsets.UTF_8).trim());
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof XMLFileCommitter)) return false;
        final XMLFileCommitter other = (XMLFileCommitter) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof XMLFileCommitter;
    }
    ...
    public java.lang.String toString() {
        return "XMLFileCommitter(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public XMLFileCommitterConfig getConfiguration() {
