...
public abstract class AbstractBatchCommitter<T extends BaseBatchCommitterConfig> extends AbstractCommitter<T> implements BatchConsumer {
    ...
    @Override
    public void consume(Iterator<CommitterRequest> it) throws CommitterException {
     ...
     */
    protected abstract void commitBatch(Iterator<CommitterRequest> it) throws CommitterException;
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof AbstractBatchCommitter)) return false;
        final AbstractBatchCommitter<?> other = (AbstractBatchCommitter<?>) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof AbstractBatchCommitter;
    }
    ...
    public java.lang.String toString() {
        return "AbstractBatchCommitter(super=" + super.toString() + ")";
    }
}
