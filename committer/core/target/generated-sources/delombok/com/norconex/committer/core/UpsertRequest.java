...
public class UpsertRequest implements CommitterRequest {
    ...
    public UpsertRequest(@NonNull String reference, Properties metadata, InputStream content) {
        java.util.Objects.requireNonNull(reference, "reference is marked non-null but is null");
        this.reference = reference;
        if (metadata != null) {
            this.metadata.putAll(metadata);
        }
        this.content = content != null ? content : InputStream.nullInputStream();
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof UpsertRequest)) return false;
        final UpsertRequest other = (UpsertRequest) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof UpsertRequest;
    }
    ...
    public java.lang.String toString() {
        return "UpsertRequest(reference=" + this.getReference() + ", metadata=" + this.getMetadata() + ", content=" + this.getContent() + ")";
    }
}
