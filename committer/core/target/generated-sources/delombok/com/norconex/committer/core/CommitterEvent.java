...
//                .build();
    ...
    @lombok.Generated
    public static abstract class CommitterEventBuilder<C extends CommitterEvent, B extends CommitterEvent.CommitterEventBuilder<C, B>> extends Event.EventBuilder<C, B> {
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        private CommitterRequest request;
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public B request(final CommitterRequest request) {
        ...
        public java.lang.String toString() {
            return "CommitterEvent.CommitterEventBuilder(super=" + super.toString() + ", request=" + this.request + ")";
        }
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final class CommitterEventBuilderImpl extends CommitterEvent.CommitterEventBuilder<CommitterEvent, CommitterEvent.CommitterEventBuilderImpl> {
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        private CommitterEventBuilderImpl() {
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        protected CommitterEvent.CommitterEventBuilderImpl self() {
            return this;
        }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    protected CommitterEvent(final CommitterEvent.CommitterEventBuilder<?, ?> b) {
        super(b);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public static CommitterEvent.CommitterEventBuilder<?, ?> builder() {
        return new CommitterEvent.CommitterEventBuilderImpl();
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CommitterRequest getRequest() {
        return this.request;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof CommitterEvent)) return false;
        final CommitterEvent other = (CommitterEvent) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof CommitterEvent;
    }
