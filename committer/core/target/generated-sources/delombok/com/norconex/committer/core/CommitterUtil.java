...
public final class CommitterUtil {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CommitterUtil.class);
    ...
    public static String getContentAsString(CommitterRequest req) throws CommitterException {
        if (req instanceof UpsertRequest upsertRequest) {
            try {
                ...
                throw new CommitterException("Could not load document content for : " + req.getReference(), e);
            }
        }
        return null;
    }
    ...
    public static String extractSourceIdValue(CommitterRequest req, String sourceIdField, boolean keepSourceIdField) {
        ...
        if (StringUtils.isNotBlank(sourceIdField)) {
            ...
            if (StringUtils.isNotBlank(idValue)) {
                ...
                LOG.warn("Source ID field \"{}\" has no value. " + "Falling back to using document reference: {}", sourceIdField, req.getReference());
            }
        }
    ...
    public static void applyTargetContent(CommitterRequest req, String targetContentField) throws CommitterException {
        if (req instanceof UpsertRequest && StringUtils.isNotBlank(targetContentField)) {
