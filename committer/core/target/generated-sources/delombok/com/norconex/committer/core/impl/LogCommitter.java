...
public class LogCommitter extends AbstractCommitter<LogCommitterConfig> {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(LogCommitter.class);
    ...
    protected void doUpsert(UpsertRequest upsertRequest) throws CommitterException {
        ...
        b.append("\n=== DOCUMENT UPSERTED ================================\n");
        stringifyRefAndMeta(b, upsertRequest.getReference(), upsertRequest.getMetadata());
        if (!configuration.isIgnoreContent()) {
            b.append("\n--- Content ---------------------------------------\n");
            try {
                b.append(IOUtils.toString(upsertRequest.getContent(), UTF_8)).append('\n');
            } catch (IOException e) {
    ...
    protected void doDelete(DeleteRequest deleteRequest) throws CommitterException {
        var b = new StringBuilder();
        b.append("\n=== DOCUMENT DELETED =================================\n");
        stringifyRefAndMeta(b, deleteRequest.getReference(), deleteRequest.getMetadata());
        log(b.toString());
        removeCount++;
    ...
    private void stringifyRefAndMeta(StringBuilder b, String reference, Properties metadata) {
        b.append("REFERENCE = ").append(reference).append('\n');
        if (metadata != null) {
            b.append("\n--- Metadata: -------------------------------------\n");
            for (Entry<String, List<String>> en : metadata.entrySet()) {
                if (configuration.getFieldMatcher().getPattern() == null || configuration.getFieldMatcher().matches(en.getKey())) {
                    for (String val : en.getValue()) {
                        b.append(en.getKey()).append(" = ").append(val).append('\n');
                    }
                }
            }
        }
    ...
    private void log(String txt) {
        var lvl = Optional.ofNullable(configuration.getLogLevel()).orElse(LogLevel.INFO);
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof LogCommitter)) return false;
        final LogCommitter other = (LogCommitter) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
        if (!super.equals(o)) return false;
        if (this.getAddCount() != other.getAddCount()) return false;
        if (this.getRemoveCount() != other.getRemoveCount()) return false;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof LogCommitter;
    }
    ...
    public int hashCode() {
        ...
        final long $addCount = this.getAddCount();
        result = result * PRIME + (int) ($addCount >>> 32 ^ $addCount);
        final long $removeCount = this.getRemoveCount();
        result = result * PRIME + (int) ($removeCount >>> 32 ^ $removeCount);
    ...
    public java.lang.String toString() {
        return "LogCommitter(super=" + super.toString() + ", addCount=" + this.getAddCount() + ", removeCount=" + this.getRemoveCount() + ", configuration=" + this.getConfiguration() + ")";
    }
}
