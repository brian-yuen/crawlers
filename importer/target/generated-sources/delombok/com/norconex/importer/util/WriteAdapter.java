...
public class WriteAdapter {
    ...
    public Writer asWriter(Charset charset) {
        ...
        var writer = new OutputStreamWriter(IOUtil.toNonNullOutputStream(os), ObjectUtils.firstNonNull(charset, defaultCharset, StandardCharsets.UTF_8));
    ...
    @lombok.Generated
    public WriteAdapter(final Supplier<OutputStream> outputSupplier, final Charset defaultCharset) {
        this.outputSupplier = outputSupplier;
