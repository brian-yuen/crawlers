...
public final class CommonAttributesResolver {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CommonAttributesResolver.class);
    ...
    private static void resolveContenTypeAndFamily(Doc doc, boolean overwrite) {
        ...
        if (overwrite || docRecord.getContentType() == null) {
            try {
                docRecord.setContentType(ContentTypeDetector.detect(doc.getInputStream(), doc.getReference()));
            } catch (IOException e) {
        ...
        if (overwrite || (meta.getString(CONTENT_FAMILY) == null && ct != null)) {
    ...
    private static void resolveContentEncoding(Doc doc, boolean overwrite) {
        ...
        if (overwrite || docRecord.getCharset() == null) {
            try {
                docRecord.setCharset(CharsetDetector.builder().build().detect(doc.getInputStream()));
            } catch (IOException e) {
        ...
        if (overwrite || (meta.getString(CONTENT_ENCODING) == null && enc != null)) {
