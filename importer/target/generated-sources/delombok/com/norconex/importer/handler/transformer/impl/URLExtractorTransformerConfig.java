...
public class URLExtractorTransformerConfig implements ChunkedTextSupport {
     ...
     */
    public URLExtractorTransformerConfig setFieldMatcher(TextMatcher fieldMatcher) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public URLExtractorTransformerConfig setToField(final String toField) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public URLExtractorTransformerConfig setOnSet(final PropertySetter onSet) {
        this.onSet = onSet;
        return this;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public URLExtractorTransformerConfig setMaxReadSize(final int maxReadSize) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public URLExtractorTransformerConfig setSourceCharset(final Charset sourceCharset) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof URLExtractorTransformerConfig)) return false;
        final URLExtractorTransformerConfig other = (URLExtractorTransformerConfig) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof URLExtractorTransformerConfig;
    }
    ...
    public java.lang.String toString() {
        return "URLExtractorTransformerConfig(fieldMatcher=" + this.getFieldMatcher() + ", toField=" + this.getToField() + ", onSet=" + this.getOnSet() + ", maxReadSize=" + this.getMaxReadSize() + ", sourceCharset=" + this.getSourceCharset() + ")";
    }
}
