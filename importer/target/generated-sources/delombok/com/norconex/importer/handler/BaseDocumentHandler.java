...
//            }
            ...
            throw new UncheckedIOException("Importer failure for handler: " + this, e);
        }
    ...
    private void fireEvent(DocContext ctx, String eventName, Exception e) {
        ctx.eventManager().fire(ImporterEvent.builder().name(eventName).source(this).document(ctx.doc()).parseState(ctx.parseState()).exception(e).build());
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof BaseDocumentHandler)) return false;
        final BaseDocumentHandler other = (BaseDocumentHandler) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof BaseDocumentHandler;
    }
