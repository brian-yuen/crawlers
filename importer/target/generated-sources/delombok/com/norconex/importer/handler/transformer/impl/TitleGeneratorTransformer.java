...
public class TitleGeneratorTransformer extends BaseDocumentHandler implements Configurable<TitleGeneratorTransformerConfig> {
    ...
    private final TitleGeneratorTransformerConfig configuration = new TitleGeneratorTransformerConfig();
    @JsonIgnore
    private final EntryValueComparator entryValueComparator = new EntryValueComparator();
    ...
    public void handle(DocContext docCtx) throws IOException {
        ChunkedTextReader.from(configuration).read(docCtx, chunk -> {
            ...
            if (chunk.getChunkIndex() > 0 || (PropertySetter.OPTIONAL == configuration.getOnSet() && StringUtils.isNotBlank(docCtx.metadata().getString(getTargetField())))) {
                return false;
            }
            ...
            if (StringUtils.isNotBlank(title)) {
                if (configuration.getTitleMaxLength() >= 0 && title.length() > configuration.getTitleMaxLength()) {
                    title = StringUtils.substring(title, 0, configuration.getTitleMaxLength());
                    title += "[...]";
                }
                PropertySetter.orAppend(configuration.getOnSet()).apply(docCtx.metadata(), getTargetField(), title);
            }
            return true;
        });
    }
    ...
    private String getTargetField() {
        return StringUtils.firstNonBlank(configuration.getToField(), TitleGeneratorTransformerConfig.DEFAULT_TO_FIELD);
    }
    ...
    private String getHeadingTitle(String text) {
        ...
        if (StringUtils.isBlank(firstLine) || (StringUtils.split(firstLine, "?!.").length != 1) || firstLine.length() < configuration.getDetectHeadingMinLength() || firstLine.length() > configuration.getDetectHeadingMaxLength()) {
            return null;
        }
        return firstLine;
    }
    ...
    private String summarize(String text) {
        ...
        for (String sentence : index.sentences) {
            ...
            for (TermOccurence to : index.terms) {
                var m = Pattern.compile("\\b\\Q" + to.term + "\\E\\b").matcher(sentence);
                var count = 0;
                while (m.find()) {
                    count++;
                }
    ...
    private Index indexText(String text) {
        ...
        while (end != BreakIterator.DONE) {
            ...
            for (String sentence : sentences) {
                ...
                if (s != null && Character.isLetterOrDigit(sentence.codePointAt(0))) {
        ...
        List<Entry<String, AtomicInteger>> sorted = new ArrayList<>(terms.entrySet());
        ...
        for (Entry<String, AtomicInteger> entry : sorted) {
            ...
            if (term.length() >= MIN_TERM_LENGTH && occurences >= MIN_OCCURENCES) {
    ...
    private void breakWords(String sentence, ConcurrentMap<String, AtomicInteger> terms) {
    ...
    //--- Inner classes --------------------------------------------------------
    class EntryValueComparator implements Comparator<Entry<String, AtomicInteger>> {
        @Override
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof TitleGeneratorTransformer.EntryValueComparator)) return false;
            final TitleGeneratorTransformer.EntryValueComparator other = (TitleGeneratorTransformer.EntryValueComparator) o;
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof TitleGeneratorTransformer.EntryValueComparator;
        }
        ...
        public java.lang.String toString() {
            return "TitleGeneratorTransformer.EntryValueComparator()";
        }
    }
    ...
    class Index {
        ...
        public boolean equals(final java.lang.Object o) {
            if (o == this) return true;
            if (!(o instanceof TitleGeneratorTransformer.Index)) return false;
            final TitleGeneratorTransformer.Index other = (TitleGeneratorTransformer.Index) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
            final java.lang.Object this$sentences = this.sentences;
            final java.lang.Object other$sentences = other.sentences;
        ...
        @lombok.Generated
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof TitleGeneratorTransformer.Index;
        }
        ...
        public int hashCode() {
            final int PRIME = 59;
            int result = 1;
            final java.lang.Object $sentences = this.sentences;
        ...
        @lombok.Generated
        public java.lang.String toString() {
            return "TitleGeneratorTransformer.Index(sentences=" + this.sentences + ", terms=" + this.terms + ")";
        }
    }
    ...
    class TermOccurence implements Comparable<TermOccurence> {
        ...
        public boolean equals(final java.lang.Object o) {
            if (o == this) return true;
            if (!(o instanceof TitleGeneratorTransformer.TermOccurence)) return false;
            final TitleGeneratorTransformer.TermOccurence other = (TitleGeneratorTransformer.TermOccurence) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
            if (this.occurence != other.occurence) return false;
            final java.lang.Object this$term = this.term;
            final java.lang.Object other$term = other.term;
        ...
        @lombok.Generated
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof TitleGeneratorTransformer.TermOccurence;
        }
        ...
        public int hashCode() {
            final int PRIME = 59;
            int result = 1;
            result = result * PRIME + this.occurence;
            final java.lang.Object $term = this.term;
        ...
        @lombok.Generated
        public java.lang.String toString() {
            return "TitleGeneratorTransformer.TermOccurence(term=" + this.term + ", occurence=" + this.occurence + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public TitleGeneratorTransformer() {
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public TitleGeneratorTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this) return true;
        if (!(o instanceof TitleGeneratorTransformer)) return false;
        final TitleGeneratorTransformer other = (TitleGeneratorTransformer) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
    ...
    @lombok.Generated
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof TitleGeneratorTransformer;
    }
    ...
    @lombok.Generated
    public java.lang.String toString() {
        return "TitleGeneratorTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
