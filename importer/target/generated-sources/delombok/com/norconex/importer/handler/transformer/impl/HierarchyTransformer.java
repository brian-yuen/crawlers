...
public class HierarchyTransformer extends BaseDocumentHandler implements Configurable<HierarchyTransformerConfig> {
    private final HierarchyTransformerConfig configuration = new HierarchyTransformerConfig();

    @Override
    public void handle(DocContext docCtx) throws IOException {
        configuration.getOperations().forEach(op -> breakSegments(docCtx.metadata(), op));
    }
    ...
    private void breakSegments(Properties metadata, HierarchyOperation op) {
        ...
        for (String value : metadata.getStrings(op.getFromField())) {
            ...
            if (!op.isKeepEmptySegments()) {
                var iter = segments.listIterator(segments.size());
        ...
        if (StringUtils.isNotBlank(op.getToField())) {
            // set on target field
            PropertySetter.orAppend(op.getOnSet()).apply(metadata, op.getToField(), paths);
        } else {
    ...
    private static class Separator {
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof HierarchyTransformer.Separator)) return false;
            final HierarchyTransformer.Separator other = (HierarchyTransformer.Separator) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
            final java.lang.Object this$sep = this.sep;
            final java.lang.Object other$sep = other.sep;
            if (this$sep == null ? other$sep != null : !this$sep.equals(other$sep)) return false;
            return true;
        }
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof HierarchyTransformer.Separator;
        }
        ...
        public int hashCode() {
            final int PRIME = 59;
            int result = 1;
            final java.lang.Object $sep = this.sep;
            result = result * PRIME + ($sep == null ? 43 : $sep.hashCode());
            return result;
        }
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public HierarchyTransformer() {
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public HierarchyTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this) return true;
        if (!(o instanceof HierarchyTransformer)) return false;
        final HierarchyTransformer other = (HierarchyTransformer) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
    ...
    @lombok.Generated
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof HierarchyTransformer;
    }
    ...
    public java.lang.String toString() {
        return "HierarchyTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
