 ...
 * </p>
 */
public class NumericCondition extends BaseCondition implements Configurable<NumericConditionConfig> {
    private final NumericConditionConfig configuration = new NumericConditionConfig();

    @Override
    public boolean evaluate(DocContext docCtx) throws IOException {
        for (String valueStr : docCtx.metadata().matchKeys(configuration.getFieldMatcher()).valueList()) {
            if (!NumberUtils.isCreatable(valueStr)) {
                continue;
            }
            var number = NumberUtils.toDouble(valueStr);
            if (matches(configuration.getValueMatcher(), number) && matches(configuration.getValueMatcherRangeEnd(), number)) {
                return true;
            }
        }
        return false;
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof NumericCondition)) return false;
        final NumericCondition other = (NumericCondition) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof NumericCondition;
    }
    ...
    public java.lang.String toString() {
        return "NumericCondition(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public NumericConditionConfig getConfiguration() {
