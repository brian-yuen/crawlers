...
public class KeepOnlyTransformer extends BaseDocumentHandler implements Configurable<KeepOnlyTransformerConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(KeepOnlyTransformer.class);
    private final KeepOnlyTransformerConfig configuration = new KeepOnlyTransformerConfig();
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public KeepOnlyTransformer() {
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public KeepOnlyTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof KeepOnlyTransformer)) return false;
        final KeepOnlyTransformer other = (KeepOnlyTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof KeepOnlyTransformer;
    }
    ...
    public java.lang.String toString() {
        return "KeepOnlyTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
