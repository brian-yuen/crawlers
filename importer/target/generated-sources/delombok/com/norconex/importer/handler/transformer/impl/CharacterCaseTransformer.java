...
public class CharacterCaseTransformer extends BaseDocumentHandler implements Configurable<CharacterCaseTransformerConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CharacterCaseTransformer.class);
    private final CharacterCaseTransformerConfig configuration = new CharacterCaseTransformerConfig();
    ...
    private void doFields(DocContext docCtx) {
        ...
        if (StringUtils.isNotBlank(applyTo) && !StringUtils.equalsAnyIgnoreCase(applyTo, APPLY_FIELD, APPLY_VALUE, APPLY_BOTH)) {
        ...
        for (Entry<String, List<String>> en : docCtx.metadata().matchKeys(configuration.getFieldMatcher()).entrySet()) {
            ...
            // Do values
            if (StringUtils.isBlank(applyTo) || EqualsUtil.equalsAny(applyTo, APPLY_VALUE, APPLY_BOTH)) {
    ...
    private void changeValuesCase(String field, Properties metadata) {
        var values = metadata.getStrings(field);
        if (values != null) {
    ...
    private String capitalizeString(String value) {
        if (StringUtils.isNotBlank(value)) {
            var m = Pattern.compile("^(.*?)([\\p{IsAlphabetic}\\p{IsDigit}])").matcher(value);
            if (m.find()) {
                var firstChar = StringUtils.upperCase(m.group(2), Locale.ENGLISH);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CharacterCaseTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof CharacterCaseTransformer)) return false;
        final CharacterCaseTransformer other = (CharacterCaseTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof CharacterCaseTransformer;
    }
    ...
    public java.lang.String toString() {
        return "CharacterCaseTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
