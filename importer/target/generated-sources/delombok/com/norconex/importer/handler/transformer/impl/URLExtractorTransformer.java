...
public class URLExtractorTransformer extends BaseDocumentHandler implements Configurable<URLExtractorTransformerConfig> {
    private static final Pattern URL_PATTERN = Regex.compileDotAll("\\b(https?:|www\\.)[^\\s]+", true);
    private final URLExtractorTransformerConfig configuration = new URLExtractorTransformerConfig();
    ...
    public void handle(DocContext docCtx) throws IOException {
        ...
        if (configuration.getFieldMatcher().isSet()) {
            ...
            extractContentURLs(urls, docCtx.input().asReader(configuration.getSourceCharset()));
        }
        if (!urls.isEmpty()) {
            PropertySetter.orAppend(configuration.getOnSet()).apply(docCtx.metadata(), configuration.getToField(), urls);
        }
    }

    private void extractMetadataURLs(Set<String> urls, Properties meta) {
        for (String text : meta.matchKeys(configuration.getFieldMatcher()).valueList()) {
            extractURLs(urls, text);
        }
    }

    private void extractContentURLs(Set<String> urls, Reader reader) throws IOException {
        String text = null;
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public URLExtractorTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof URLExtractorTransformer)) return false;
        final URLExtractorTransformer other = (URLExtractorTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof URLExtractorTransformer;
    }
    ...
    public java.lang.String toString() {
        return "URLExtractorTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
