...
public class LanguageTransformer extends BaseDocumentHandler implements Configurable<LanguageTransformerConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(LanguageTransformer.class);
    private final LanguageTransformerConfig configuration = new LanguageTransformerConfig();
    ...
    @JsonIgnore
    private final Comparator<LanguageResult> langResultComparator = Comparator.comparing(LanguageResult::getRawScore).reversed();
    ...
    public void handle(DocContext docCtx) throws IOException {
        ...
        ChunkedTextReader.from(configuration).read(docCtx, chunk -> {
            ...
            if (results.isEmpty()) {
                LOG.debug("No language found, using fallback language " + "for {}.", docCtx.reference());
                docCtx.metadata().set(DocMetadata.LANGUAGE, configuration.getFallbackLanguage());
            } else {
                Collections.sort(results, langResultComparator);
                docCtx.metadata().set(DocMetadata.LANGUAGE, results.get(0).getLanguage());
                if (configuration.isKeepProbabilities()) {
                    var count = 0;
                    for (LanguageResult lang : results) {
                        count++;
                        var prefix = DocMetadata.LANGUAGE + "." + count;
                        docCtx.metadata().set(prefix + ".tag", lang.getLanguage());
                        docCtx.metadata().set(prefix + ".probability", lang.getRawScore());
                    }
                }
            }
    ...
    private synchronized void ensureDetectorInitialization() throws IOException {
        if (detector == null) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public LanguageTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof LanguageTransformer)) return false;
        final LanguageTransformer other = (LanguageTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof LanguageTransformer;
    }
    ...
    public java.lang.String toString() {
        return "LanguageTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
