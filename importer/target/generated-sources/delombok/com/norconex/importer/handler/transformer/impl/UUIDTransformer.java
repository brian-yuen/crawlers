...
public class UUIDTransformer extends BaseDocumentHandler implements Configurable<UUIDTransformerConfig> {
    private final UUIDTransformerConfig configuration = new UUIDTransformerConfig();
    ...
    public void handle(DocContext docCtx) throws IOException {
        ...
        PropertySetter.orAppend(configuration.getOnSet()).apply(docCtx.metadata(), finalField, uuid);
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public UUIDTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof UUIDTransformer)) return false;
        final UUIDTransformer other = (UUIDTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof UUIDTransformer;
    }
    ...
    public java.lang.String toString() {
        return "UUIDTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
