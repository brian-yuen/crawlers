...
public class MergeTransformer extends BaseDocumentHandler implements Configurable<MergeTransformerConfig> {
    private final MergeTransformerConfig configuration = new MergeTransformerConfig();
    ...
    public void handle(DocContext docCtx) throws IOException {
        for (MergeOperation op : configuration.getOperations()) {
            ...
            for (Entry<String, List<String>> en : docCtx.metadata().matchKeys(op.getFieldMatcher()).entrySet()) {
                ...
                // Delete if necessary
                if (op.isDeleteFromFields()) {
                    docCtx.metadata().remove(field);
                }
            }
            // Store in target field
            if (op.isSingleValue()) {
                docCtx.metadata().set(op.getToField(), StringUtils.join(mergedValues, op.getSingleValueSeparator()));
            } else {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public MergeTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof MergeTransformer)) return false;
        final MergeTransformer other = (MergeTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof MergeTransformer;
    }
    ...
    public java.lang.String toString() {
        return "MergeTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
