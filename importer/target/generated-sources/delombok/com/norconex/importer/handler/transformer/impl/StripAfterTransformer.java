...
public class StripAfterTransformer extends BaseDocumentHandler implements Configurable<StripAfterTransformerConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(StripAfterTransformer.class);
    private final StripAfterTransformerConfig configuration = new StripAfterTransformerConfig();
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public StripAfterTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof StripAfterTransformer)) return false;
        final StripAfterTransformer other = (StripAfterTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof StripAfterTransformer;
    }
    ...
    public java.lang.String toString() {
        return "StripAfterTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
