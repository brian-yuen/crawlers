...
public class DocumentLengthTransformer extends BaseDocumentHandler implements Configurable<DocumentLengthTransformerConfig> {
    private final DocumentLengthTransformerConfig configuration = new DocumentLengthTransformerConfig();
    ...
    public void handle(DocContext docCtx) throws IOException {
        ...
        PropertySetter.orAppend(configuration.getOnSet()).apply(docCtx.metadata(), configuration.getToField(), length);
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public DocumentLengthTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof DocumentLengthTransformer)) return false;
        final DocumentLengthTransformer other = (DocumentLengthTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DocumentLengthTransformer;
    }
    ...
    public java.lang.String toString() {
        return "DocumentLengthTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
