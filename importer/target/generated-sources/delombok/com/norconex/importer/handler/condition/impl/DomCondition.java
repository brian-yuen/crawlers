...
public class DomCondition extends BaseCondition implements Configurable<DomConditionConfig> {
    private final DomConditionConfig configuration = new DomConditionConfig();
    ...
    public boolean evaluate(DocContext docCtx) throws IOException {
        ...
        ChunkedTextReader.builder().charset(configuration.getSourceCharset()).fieldMatcher(configuration.getFieldMatcher()).maxChunkSize(-1).build().read(docCtx, chunk -> {
            ...
            if (matches.isFalse() && testDocument(Jsoup.parse(chunk.getText(), docCtx.reference(), toJSoupParser(configuration.getParser())))) {
                matches.setTrue();
            }
            return true;
        });
    ...
    private boolean testDocument(Document doc) {
        ...
        for (Element elm : elms) {
            var value = DomUtil.getElementValue(elm, configuration.getExtract());
            if (configuration.getValueMatcher().getPattern() == null || configuration.getValueMatcher().matches(value)) {
                return true;
            }
        }
        return false;
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public DomConditionConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof DomCondition)) return false;
        final DomCondition other = (DomCondition) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DomCondition;
    }
    ...
    public java.lang.String toString() {
        return "DomCondition(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
