...
public class ScriptCondition extends BaseCondition implements Configurable<ScriptConditionConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ScriptCondition.class);
    ...
    private final ScriptConditionConfig configuration = new ScriptConditionConfig();
    @JsonIgnore
    ...
    private boolean executeScript(DocContext docCtx, TextChunk chunk) throws DocumentHandlerException {
    ...
    private synchronized ScriptRunner<Object> scriptRunner() throws DocumentHandlerException {
        if (scriptRunner == null) {
            ...
            if (StringUtils.isBlank(engineName)) {
                LOG.info("Script engine name not specified, defaulting to " + ScriptRunner.JAVASCRIPT_ENGINE);
                engineName = ScriptRunner.JAVASCRIPT_ENGINE;
            }
            scriptRunner = new ScriptRunner<>(engineName, configuration.getScript());
        }
        return scriptRunner;
    }
    ...
    public java.lang.String toString() {
        return "ScriptCondition(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ScriptCondition)) return false;
        final ScriptCondition other = (ScriptCondition) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ScriptCondition;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ScriptConditionConfig getConfiguration() {
