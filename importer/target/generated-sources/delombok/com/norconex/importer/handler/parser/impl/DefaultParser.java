 ...
 * TikaParser.
 */
public class DefaultParser extends BaseDocumentHandler implements Configurable<DefaultParserConfig> {
    ...
    public void init() throws IOException {
        fixTikaInitWarning();
        tikaParser = new AutoDetectParser(DefTikaConfigurer.configure(configuration));
    }
    ...
    public void handle(DocContext ctx) throws IOException {
        ...
        tikaMetadata.set(HttpHeaders.CONTENT_ENCODING, ofNullable(ctx.docRecord().getCharset()).map(Charset::toString).orElse(null));
        try (
            var input = CachedInputStream.cache(ctx.input().asInputStream());
            var output = ctx.output().asWriter(UTF_8)) {
            tikaMetadata.set(HttpHeaders.CONTENT_LENGTH, Long.toString(input.length()));
            var recursiveParser = createRecursiveParser(ctx, output, embeddedDocs);
            ...
            recursiveParser.parse(input, new BodyContentHandler(output), tikaMetadata, context);
    ...
    protected Parser createRecursiveParser(DocContext docCtx, Writer output, List<Doc> embeddedDocs) {
        // if the current file (container) matches, we extract (split)
        // its embedded documents (else, we merge).
        if (TextMatcher.anyMatches(configuration.getEmbeddedConfig().getSplitContentTypes(), docCtx.docRecord().getContentType().toBaseTypeString())) {
            return new RecursiveEmbeddedSplitter(tikaParser, docCtx, embeddedDocs, configuration.getEmbeddedConfig());
        }
        return new RecursiveEmbeddedMerger(tikaParser, output, docCtx, configuration.getEmbeddedConfig());
    }
    ...
    private void fixTikaInitWarning() {
        ...
        try {
            FieldUtils.writeStaticField(TesseractOCRParser.class, "HAS_WARNED", true, true);
        } catch (IllegalAccessException | IllegalArgumentException e) {
            LOG.warn("Could not disable invalid Tessaract OCR warning. " + "If you see such warning, you can ignore.");
        }
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof DefaultParser)) return false;
        final DefaultParser other = (DefaultParser) o;
        ...
        final java.lang.Object this$tikaParser = this.tikaParser;
        final java.lang.Object other$tikaParser = other.tikaParser;
        if (this$tikaParser == null ? other$tikaParser != null : !this$tikaParser.equals(other$tikaParser)) return false;
        return true;
    }
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DefaultParser;
    }
    ...
    public int hashCode() {
        ...
        final java.lang.Object $tikaParser = this.tikaParser;
        result = result * PRIME + ($tikaParser == null ? 43 : $tikaParser.hashCode());
        return result;
    }
    ...
    public java.lang.String toString() {
        return "DefaultParser(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ", tikaParser=" + this.tikaParser + ")";
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public DefaultParserConfig getConfiguration() {
