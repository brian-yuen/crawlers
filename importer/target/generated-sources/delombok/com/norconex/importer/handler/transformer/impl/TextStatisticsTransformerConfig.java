...
public class TextStatisticsTransformerConfig {
     ...
     */
    public TextStatisticsTransformerConfig setFieldMatcher(TextMatcher fieldMatcher) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public TextStatisticsTransformerConfig setSourceCharset(final Charset sourceCharset) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof TextStatisticsTransformerConfig)) return false;
        final TextStatisticsTransformerConfig other = (TextStatisticsTransformerConfig) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof TextStatisticsTransformerConfig;
    }
    ...
    public java.lang.String toString() {
        return "TextStatisticsTransformerConfig(sourceCharset=" + this.getSourceCharset() + ", fieldMatcher=" + this.getFieldMatcher() + ")";
    }
}
