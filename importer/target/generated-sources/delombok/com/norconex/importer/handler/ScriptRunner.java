...
public class ScriptRunner<T> {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ScriptRunner.class);
    ...
    public ScriptRunner(@NonNull String engineName, @NonNull String script) {
        ...
        java.util.Objects.requireNonNull(engineName, "engineName is marked non-null but is null");
        java.util.Objects.requireNonNull(script, "script is marked non-null but is null");
    }

    private ScriptRunner(ScriptEngine engine, String engineName, String script) {
        this.engine = engine;
    ...
    public T eval(Consumer<Bindings> binder) throws DocumentHandlerException {
        ...
        try {
            ...
            if (returnValue == null && EqualsUtil.equalsAnyIgnoreCase(engineName, JAVASCRIPT_ENGINE, LUA_ENGINE)) {
    ...
    private static CompiledScript compileScript(ScriptEngine engine, String script) {
        if (engine instanceof Compilable compileEngine) {
            try {
                return compileEngine.compile(script);
            } catch (ScriptException e) {
                throw new IllegalArgumentException("Invalid script argument. Could not compile. Possibly " + "a syntax error.", e);
            }
        }
        return null;
    }
    ...
    private static void throwInvalidEngine(String name) {
        ...
        LOG.error("Invalid Script Engine \"{}\". " + "Detected Script Engines are:\n{}", name, b.toString());
        throw new IllegalArgumentException("No JSR 223 Script Engine found matching the " + "name \"" + name + "\".");
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ScriptRunner)) return false;
        final ScriptRunner<?> other = (ScriptRunner<?>) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ScriptRunner;
    }
    ...
    public java.lang.String toString() {
        return "ScriptRunner(engineName=" + this.getEngineName() + ", script=" + this.getScript() + ")";
    }
