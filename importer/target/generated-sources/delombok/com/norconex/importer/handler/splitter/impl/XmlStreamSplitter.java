...
public class XmlStreamSplitter extends AbstractDocumentSplitter<XmlStreamSplitterConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(XmlStreamSplitter.class);
    private final XmlStreamSplitterConfig configuration = new XmlStreamSplitterConfig();

    @Override
    public void split(DocContext docCtx) throws IOException {
        if (!MatchUtil.matchesContentType(configuration.getContentTypeMatcher(), docCtx.docRecord())) {
        }
    ...
    private void doSplit(DocContext docCtx, InputStream is) throws IOException {
        try (is) {
            var h = new XmlHandler(docCtx, Arrays.asList(StringUtils.split(configuration.getPath(), '/')), docCtx.childDocs());
            XMLUtil.createSaxParserFactory().newSAXParser().parse(is, h);
        } catch (SAXException | IOException | ParserConfigurationException e) {
            throw new DocumentHandlerException("Could not split XML document: " + docCtx.reference(), e);
        }
    }
    ...
    static class XmlHandler extends DefaultHandler {
        ...
        public XmlHandler(DocContext xmlDoc, List<String> splitPath, List<Doc> splitDocs) {
            this.xmlDoc = xmlDoc;
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            ...
            if (w != null) {
                ...
                for (var i = 0; i < attributes.getLength(); i++) {
                    w.print(' ' + esc(attributes.getQName(i)) + "=\"" + esc(attributes.getValue(i)) + "\"");
                }
                w.print('>');
            }
        }
            ...
            try {
                if (w != null) {
                    ...
                    if (currentPath.equals(splitPath)) {
                        ...
                        var childDoc = new Doc(xmlDoc.reference() + "!" + embedRef, out.getInputStream(), childMeta);
                        w.close();
                        out = null;
                        w = null;
                        var childInfo = childDoc.getDocRecord();
                        childInfo.addEmbeddedParentReference(xmlDoc.reference());
                        childMeta.set(DocMetadata.EMBEDDED_REFERENCE, embedRef);
                        splitDocs.add(childDoc);
                    }
                }
            } catch (IOException e) {
                throw new SAXException("Cannot parse XML for document: " + xmlDoc.reference(), e);
            }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public XmlStreamSplitterConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof XmlStreamSplitter)) return false;
        final XmlStreamSplitter other = (XmlStreamSplitter) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof XmlStreamSplitter;
    }
    ...
    public java.lang.String toString() {
        return "XmlStreamSplitter(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
