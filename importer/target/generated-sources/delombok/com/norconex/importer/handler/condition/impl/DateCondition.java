...
public class DateCondition extends BaseCondition implements Configurable<DateConditionConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DateCondition.class);


    public enum TimeUnit {
        YEAR(ChronoUnit.YEARS, "Y"), MONTH(ChronoUnit.MONTHS, "M"), DAY(ChronoUnit.DAYS, "D"), HOUR(ChronoUnit.HOURS, "h"), MINUTE(ChronoUnit.MINUTES, "m"), SECOND(ChronoUnit.SECONDS, "s");
    ...
    private final DateConditionConfig configuration = new DateConditionConfig();

    @Override
    public boolean evaluate(DocContext docCtx) throws IOException {
        if (configuration.getFieldMatcher().getPattern() == null) {
            throw new IllegalArgumentException("\"fieldMatcher\" pattern cannot be empty.");
        }
        for (Entry<String, List<String>> en : docCtx.metadata().matchKeys(configuration.getFieldMatcher()).entrySet()) {
            for (String value : en.getValue()) {
                if (matches(configuration.getValueMatcher(), en.getKey(), value) && matches(configuration.getValueMatcherRangeEnd(), en.getKey(), value)) {
                    return true;
                }
            }
        }
    ...
    private boolean matches(DateValueMatcher matcher, String fieldName, String fieldValue) {
        if (matcher == null) {
            return true;
        }
        var dt = ZonedDateTimeParser.builder().format(configuration.getFormat()).zoneId(configuration.getDocZoneId()).build().parse(fieldValue);
        if (dt == null) {
            return false;
        }
        var evalResult = matcher.test(dt);
        LOG.debug("{}: {} [{}] {} = {}", fieldName, fieldValue, matcher.getOperator(), matcher.getDateProvider().getDateTime(), evalResult);
        return evalResult;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final DateCondition other = (DateCondition) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DateCondition;
    }
    ...
    public java.lang.String toString() {
        return "DateCondition(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public DateConditionConfig getConfiguration() {
