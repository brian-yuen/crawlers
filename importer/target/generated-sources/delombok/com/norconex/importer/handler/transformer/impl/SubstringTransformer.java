...
public class SubstringTransformer extends BaseDocumentHandler implements Configurable<SubstringTransformerConfig> {
    private final SubstringTransformerConfig configuration = new SubstringTransformerConfig();
        ...
        if (configuration.getFieldMatcher().isSet()) {
            ...
            for (Entry<String, List<String>> en : docCtx.metadata().matchKeys(configuration.getFieldMatcher()).entrySet()) {
                ...
                for (String val : values) {
                    try (
                        var input = new StringReader(val);
            ...
            // Body
            try (
                var input = docCtx.input().asReader(configuration.getSourceCharset());
                var output = docCtx.output().asWriter(configuration.getSourceCharset())) {
                doSubstring(input, output);
            }
        }
    }

    private void doSubstring(Reader input, Writer output) throws IOException {
        long length = -1;
        if (configuration.getEnd() > -1) {
            if (configuration.getEnd() < configuration.getBegin()) {
                throw new IOException("\"end\" cannot be smaller than \"begin\" " + "(begin:" + configuration.getBegin() + "; end:" + configuration.getEnd());
            }
            length = configuration.getEnd() - Math.max(configuration.getBegin(), 0);
        }
        if (length == 0) {
            output.write("");
        } else {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public SubstringTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof SubstringTransformer)) return false;
        final SubstringTransformer other = (SubstringTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof SubstringTransformer;
    }
    ...
    public java.lang.String toString() {
        return "SubstringTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
