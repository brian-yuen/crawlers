...
public class ScriptTransformer extends BaseDocumentHandler implements Configurable<ScriptTransformerConfig> {
    private final ScriptTransformerConfig configuration = new ScriptTransformerConfig();
    @JsonIgnore
    ...
    private synchronized ScriptRunner<Object> scriptRunner() {
        if (scriptRunner == null) {
            scriptRunner = new ScriptRunner<>(configuration.getEngineName(), configuration.getScript());
        }
        return scriptRunner;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ScriptTransformerConfig getConfiguration() {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setScriptRunner(final ScriptRunner<Object> scriptRunner) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ScriptTransformer)) return false;
        final ScriptTransformer other = (ScriptTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ScriptTransformer;
    }
    ...
    public java.lang.String toString() {
        return "ScriptTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
