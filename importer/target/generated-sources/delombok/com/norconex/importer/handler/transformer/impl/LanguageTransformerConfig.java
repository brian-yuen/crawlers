...
public class LanguageTransformerConfig implements ChunkedTextSupport {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public LanguageTransformerConfig setMaxReadSize(final int maxReadSize) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public LanguageTransformerConfig setSourceCharset(final Charset sourceCharset) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public LanguageTransformerConfig setKeepProbabilities(final boolean keepProbabilities) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public LanguageTransformerConfig setFallbackLanguage(final String fallbackLanguage) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof LanguageTransformerConfig)) return false;
        final LanguageTransformerConfig other = (LanguageTransformerConfig) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
        if (this.getMaxReadSize() != other.getMaxReadSize()) return false;
        if (this.isKeepProbabilities() != other.isKeepProbabilities()) return false;
        ...
        final java.lang.Object this$languages = this.getLanguages();
        final java.lang.Object other$languages = other.getLanguages();
        ...
        final java.lang.Object this$fallbackLanguage = this.getFallbackLanguage();
        final java.lang.Object other$fallbackLanguage = other.getFallbackLanguage();
        if (this$fallbackLanguage == null ? other$fallbackLanguage != null : !this$fallbackLanguage.equals(other$fallbackLanguage)) return false;
        return true;
    }
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof LanguageTransformerConfig;
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME + (this.isKeepProbabilities() ? 79 : 97);
        ...
        final java.lang.Object $languages = this.getLanguages();
        ...
        final java.lang.Object $fallbackLanguage = this.getFallbackLanguage();
        result = result * PRIME + ($fallbackLanguage == null ? 43 : $fallbackLanguage.hashCode());
        return result;
    }
    ...
    public java.lang.String toString() {
        return "LanguageTransformerConfig(maxReadSize=" + this.getMaxReadSize() + ", sourceCharset=" + this.getSourceCharset() + ", keepProbabilities=" + this.isKeepProbabilities() + ", languages=" + this.getLanguages() + ", fieldMatcher=" + this.getFieldMatcher() + ", fallbackLanguage=" + this.getFallbackLanguage() + ")";
    }
}
