...
public class CurrentDateTransformer extends BaseDocumentHandler implements Configurable<CurrentDateTransformerConfig> {
    private final CurrentDateTransformerConfig configuration = new CurrentDateTransformerConfig();
    ...
    public void handle(DocContext docCtx) throws IOException {
        ...
        PropertySetter.orAppend(configuration.getOnSet()).apply(docCtx.metadata(), finalField, dateStr);
    }
    ...
    private String nowAsString() {
        ...
        return ZonedDateTime.now(ZoneOffset.UTC).format(DateTimeFormatter.ofPattern(configuration.getFormat(), safeLocale));
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CurrentDateTransformer() {
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CurrentDateTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof CurrentDateTransformer)) return false;
        final CurrentDateTransformer other = (CurrentDateTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof CurrentDateTransformer;
    }
    ...
    public java.lang.String toString() {
        return "CurrentDateTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
