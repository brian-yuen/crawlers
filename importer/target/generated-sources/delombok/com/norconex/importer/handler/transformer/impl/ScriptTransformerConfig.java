...
public class ScriptTransformerConfig implements ChunkedTextSupport {
     ...
     */
    public ScriptTransformerConfig setFieldMatcher(TextMatcher fieldMatcher) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ScriptTransformerConfig setMaxReadSize(final int maxReadSize) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ScriptTransformerConfig setSourceCharset(final Charset sourceCharset) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ScriptTransformerConfig setEngineName(final String engineName) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ScriptTransformerConfig setScript(final String script) {
        this.script = script;
        return this;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ScriptTransformerConfig)) return false;
        final ScriptTransformerConfig other = (ScriptTransformerConfig) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ScriptTransformerConfig;
    }
    ...
    public java.lang.String toString() {
        return "ScriptTransformerConfig(maxReadSize=" + this.getMaxReadSize() + ", sourceCharset=" + this.getSourceCharset() + ", fieldMatcher=" + this.getFieldMatcher() + ", engineName=" + this.getEngineName() + ", script=" + this.getScript() + ")";
    }
}
