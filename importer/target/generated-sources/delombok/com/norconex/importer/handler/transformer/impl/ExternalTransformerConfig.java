...
public class ExternalTransformerConfig {
    ...
    private final List<RegexFieldValueExtractor> extractionPatterns = new ArrayList<>();
    /**
    ...
    public String getMetadataInputFormat() {
        return this.metadataInputFormat;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public String getMetadataOutputFormat() {
        return this.metadataOutputFormat;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ExternalTransformerConfig setCommand(final String command) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ExternalTransformerConfig setEnvironmentVariables(final Map<String, String> environmentVariables) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ExternalTransformerConfig setMetadataInputFormat(final String metadataInputFormat) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ExternalTransformerConfig setMetadataOutputFormat(final String metadataOutputFormat) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ExternalTransformerConfig setTempDir(final Path tempDir) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ExternalTransformerConfig setOnSet(final PropertySetter onSet) {
        this.onSet = onSet;
        return this;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ExternalTransformerConfig)) return false;
        final ExternalTransformerConfig other = (ExternalTransformerConfig) o;
        ...
        final java.lang.Object this$extractionPatterns = this.getExtractionPatterns();
        final java.lang.Object other$extractionPatterns = other.getExtractionPatterns();
        if (this$extractionPatterns == null ? other$extractionPatterns != null : !this$extractionPatterns.equals(other$extractionPatterns)) return false;
        ...
        final java.lang.Object this$metadataInputFormat = this.getMetadataInputFormat();
        final java.lang.Object other$metadataInputFormat = other.getMetadataInputFormat();
        if (this$metadataInputFormat == null ? other$metadataInputFormat != null : !this$metadataInputFormat.equals(other$metadataInputFormat)) return false;
        final java.lang.Object this$metadataOutputFormat = this.getMetadataOutputFormat();
        final java.lang.Object other$metadataOutputFormat = other.getMetadataOutputFormat();
        if (this$metadataOutputFormat == null ? other$metadataOutputFormat != null : !this$metadataOutputFormat.equals(other$metadataOutputFormat)) return false;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ExternalTransformerConfig;
    }
    ...
    public int hashCode() {
        ...
        final java.lang.Object $extractionPatterns = this.getExtractionPatterns();
        result = result * PRIME + ($extractionPatterns == null ? 43 : $extractionPatterns.hashCode());
        ...
        final java.lang.Object $metadataInputFormat = this.getMetadataInputFormat();
        result = result * PRIME + ($metadataInputFormat == null ? 43 : $metadataInputFormat.hashCode());
        final java.lang.Object $metadataOutputFormat = this.getMetadataOutputFormat();
        result = result * PRIME + ($metadataOutputFormat == null ? 43 : $metadataOutputFormat.hashCode());
    ...
    public java.lang.String toString() {
        return "ExternalTransformerConfig(command=" + this.getCommand() + ", extractionPatterns=" + this.getExtractionPatterns() + ", environmentVariables=" + this.getEnvironmentVariables() + ", metadataInputFormat=" + this.getMetadataInputFormat() + ", metadataOutputFormat=" + this.getMetadataOutputFormat() + ", tempDir=" + this.getTempDir() + ", onSet=" + this.getOnSet() + ")";
    }
}
