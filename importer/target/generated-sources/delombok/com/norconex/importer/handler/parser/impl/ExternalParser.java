...
public class ExternalParser extends BaseDocumentHandler implements Configurable<ExternalTransformerConfig> {
    ...
    private final ExternalTransformerConfig configuration = t.getConfiguration();
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ExternalTransformer getT() {
        return this.t;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ExternalParser)) return false;
        final ExternalParser other = (ExternalParser) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ExternalParser;
    }
    ...
    public java.lang.String toString() {
        return "ExternalParser(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
