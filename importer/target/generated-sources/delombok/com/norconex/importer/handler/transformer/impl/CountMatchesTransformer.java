...
public class CountMatchesTransformer extends BaseDocumentHandler implements Configurable<CountMatchesTransformerConfig> {
    private final CountMatchesTransformerConfig configuration = new CountMatchesTransformerConfig();
    ...
    public void handle(DocContext docCtx) throws IOException {
        ...
        if (configuration.getCountMatcher().getPattern() == null) {
            throw new IllegalArgumentException("\'countMatcher\' pattern cannot be null.");
        }
        var count = 0;
        if (configuration.getFieldMatcher().getPattern() == null) {
            count = countContentMatches(docCtx.input().asReader(configuration.getSourceCharset()));
        } else {
            count = countFieldMatches(docCtx.metadata());
        }
        PropertySetter.orAppend(configuration.getOnSet()).apply(docCtx.metadata(), configuration.getToField(), count);
    }

    private int countFieldMatches(Properties metadata) {
        var count = 0;
        for (String value : metadata.matchKeys(configuration.getFieldMatcher()).valueList()) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public CountMatchesTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof CountMatchesTransformer)) return false;
        final CountMatchesTransformer other = (CountMatchesTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof CountMatchesTransformer;
    }
    ...
    public java.lang.String toString() {
        return "CountMatchesTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
