...
public class DomConditionConfig {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public DomConditionConfig setSourceCharset(final Charset sourceCharset) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof DomConditionConfig)) return false;
        final DomConditionConfig other = (DomConditionConfig) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DomConditionConfig;
    }
    ...
    public java.lang.String toString() {
        return "DomConditionConfig(fieldMatcher=" + this.getFieldMatcher() + ", valueMatcher=" + this.getValueMatcher() + ", contentTypeMatcher=" + this.getContentTypeMatcher() + ", selector=" + this.getSelector() + ", extract=" + this.getExtract() + ", parser=" + this.getParser() + ", sourceCharset=" + this.getSourceCharset() + ")";
    }
}
