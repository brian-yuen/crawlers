...
public class TextStatisticsTransformer extends BaseDocumentHandler implements Configurable<TextStatisticsTransformerConfig> {
    private final TextStatisticsTransformerConfig configuration = new TextStatisticsTransformerConfig();
    private static final Pattern PATTERN_WORD = Pattern.compile("\\w+\\-?\\w*", Pattern.UNICODE_CHARACTER_CLASS);
    ...
    public void handle(DocContext docCtx) throws IOException {
        if (configuration.getFieldMatcher().isSet()) {
            for (Entry<String, List<String>> en : docCtx.metadata().matchKeys(configuration.getFieldMatcher()).entrySet()) {
                analyze(new StringReader(join(en.getValue(), "\n\n")), docCtx.metadata(), en.getKey());
            }
        } else {
            try (var input = docCtx.input().asReader(configuration.getSourceCharset())) {
    ...
    protected void analyze(Reader input, Properties metadata, String field) {
        ...
        metadata.add(prefix + "averageWordCharacterCount", divide(wordCharCount, wordCount));
        metadata.add(prefix + "averageSentenceCharacterCount", divide(sentenceCharCount, sentenceCount));
        metadata.add(prefix + "averageSentenceWordCount", divide(wordCount, sentenceCount));
        metadata.add(prefix + "averageParagraphCharacterCount", divide(charCount, paragraphCount));
        metadata.add(prefix + "averageParagraphSentenceCount", divide(sentenceCount, paragraphCount));
        metadata.add(prefix + "averageParagraphWordCount", divide(wordCount, paragraphCount));
    }

    private String divide(long value, long divisor) {
        return BigDecimal.valueOf(value).divide(BigDecimal.valueOf(divisor), 1, RoundingMode.HALF_UP).toString();
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public TextStatisticsTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof TextStatisticsTransformer)) return false;
        final TextStatisticsTransformer other = (TextStatisticsTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof TextStatisticsTransformer;
    }
    ...
    public java.lang.String toString() {
        return "TextStatisticsTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
