...
public class StripBetweenTransformer extends BaseDocumentHandler implements Configurable<StripBetweenTransformerConfig> {
    private final StripBetweenTransformerConfig configuration = new StripBetweenTransformerConfig();
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public StripBetweenTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof StripBetweenTransformer)) return false;
        final StripBetweenTransformer other = (StripBetweenTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof StripBetweenTransformer;
    }
    ...
    public java.lang.String toString() {
        return "StripBetweenTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
