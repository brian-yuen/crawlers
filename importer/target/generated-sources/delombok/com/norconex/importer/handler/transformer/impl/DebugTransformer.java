...
public class DebugTransformer extends BaseDocumentHandler implements Configurable<DebugTransformerConfig> {
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DebugTransformer.class);
    private final DebugTransformerConfig configuration = new DebugTransformerConfig();

    @Override
    public void handle(DocContext docCtx) throws IOException {
        var level = Level.valueOf(ObjectUtils.defaultIfNull(configuration.getLogLevel(), "debug").toUpperCase());
        if (configuration.getLogFields().isEmpty()) {
            for (Entry<String, List<String>> entry : docCtx.metadata().entrySet()) {
        ...
        if (configuration.isLogContent()) {
            SLF4JUtil.log(LOG, level, StringUtils.trimToEmpty(configuration.getPrefix()) + "CONTENT={}", IOUtils.toString(docCtx.input().asInputStream(), UTF_8));
        }
    }
    ...
    private void logField(Level level, String fieldName, List<String> values) {
        ...
        SLF4JUtil.log(LOG, level, trimToEmpty(configuration.getPrefix()) + "{}={}", fieldName, b.toString());
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public DebugTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof DebugTransformer)) return false;
        final DebugTransformer other = (DebugTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DebugTransformer;
    }
    ...
    public java.lang.String toString() {
        return "DebugTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
