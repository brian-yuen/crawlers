...
public class XmlStreamSplitterConfig extends BaseDocumentSplitterConfig {
     ...
     * @return this
     */
    public XmlStreamSplitterConfig setContentTypeMatcher(TextMatcher matcher) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public XmlStreamSplitterConfig setPath(final String path) {
        this.path = path;
        return this;
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof XmlStreamSplitterConfig)) return false;
        final XmlStreamSplitterConfig other = (XmlStreamSplitterConfig) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof XmlStreamSplitterConfig;
    }
    ...
    public java.lang.String toString() {
        return "XmlStreamSplitterConfig(super=" + super.toString() + ", path=" + this.getPath() + ", contentTypeMatcher=" + this.getContentTypeMatcher() + ", fieldMatcher=" + this.getFieldMatcher() + ")";
    }
}
