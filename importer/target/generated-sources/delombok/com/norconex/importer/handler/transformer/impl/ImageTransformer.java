...
public class ImageTransformer extends BaseDocumentHandler implements Configurable<ImageTransformerConfig> {
    private final ImageTransformerConfig configuration = new ImageTransformerConfig();
    ...
    public void transformImage(MutableImage image) {
        ...
        if (anyNotNull(sheight, swidth)) {
            var dimension = new Dimension(firstNonNull(swidth, sheight), firstNonNull(sheight, swidth));
        ...
        if (anyNotNull(cheight, cwidth)) {
            image.crop(new Rectangle(configuration.getCrop().getX(), configuration.getCrop().getY(), firstNonNull(cwidth, cheight), firstNonNull(cheight, cwidth)));
        }
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ImageTransformerConfig getConfiguration() {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ImageTransformer)) return false;
        final ImageTransformer other = (ImageTransformer) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ImageTransformer;
    }
    ...
    public java.lang.String toString() {
        return "ImageTransformer(super=" + super.toString() + ", configuration=" + this.getConfiguration() + ")";
    }
}
