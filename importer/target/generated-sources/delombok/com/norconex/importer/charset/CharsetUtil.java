...
public final class CharsetUtil {
     ...
     */
    public static String convertCharset(String input, @NonNull Charset inputCharset, @NonNull Charset outputCharset) throws IOException {
        java.util.Objects.requireNonNull(inputCharset, "inputCharset is marked non-null but is null");
        java.util.Objects.requireNonNull(outputCharset, "outputCharset is marked non-null but is null");
        return convertCharset(input, inputCharset.toString(), outputCharset.toString());
    }
    ...
    public static String convertCharset(String input, String inputCharset, String outputCharset) throws IOException {
        try (
            var is = new ByteArrayInputStream(input.getBytes(inputCharset));
     ...
     * @throws IOException problem converting character set
     */
    public static void convertCharset(@NonNull InputStream input, @NonNull Charset inputCharset, @NonNull OutputStream output, @NonNull Charset outputCharset) throws IOException {
        ...
        java.util.Objects.requireNonNull(outputCharset, "outputCharset is marked non-null but is null");
        convertCharset(input, inputCharset.toString(), output, outputCharset.toString());
    }
