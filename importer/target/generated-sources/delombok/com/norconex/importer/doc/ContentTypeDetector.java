...
public final class ContentTypeDetector {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ContentTypeDetector.class);
    ...
    // if need be.
    private static ContentType doDetect(InputStream is, String fileName) throws IOException {
        var tikaStream = TikaInputStream.get(is);
        var meta = new Metadata();
        var extension = EXTENSION_PATTERN.matcher(fileName).replaceFirst("$1");
        meta.set(TikaCoreProperties.RESOURCE_NAME_KEY, "file:///detect" + extension);
